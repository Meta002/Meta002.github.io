...
<div class="row">
  ...
  <div class="col-6">
    ...
    <form action="crearArticulosdb.php" method="POST">
      <div class="form-group">
        <label for="formGroupName">Nombre</label>
        <input type="text" class="form-control" name="nombre" id="formGroupName" placeholder="Introduce el nombre del producto" required>
        <label for="formGroupDescripcion">Descripcion</label>
        <input type="text" class="form-control" name="descripcion" id="formGroupDescripcion" placeholder="Introduce una descripcion del producto" required>
        <label for="formGroupMarca">Marca</label>
        <input type="text" class="form-control" name="marca" id="formGroupMarca" placeholder="Introduce la marca del producto" required>
        <label for="formGroupCantidad">Cantidad</label>
        <input type="number" class="form-control" name="cantidad" id="formGroupCantidad" placeholder="Introduce cantidad del producto" required>
        <label for="formGroupPrecio">Precio</label>
        <input type="number" class="form-control" name="precio" id="formGroupPrecio" placeholder="Introduce el precio del producto" step="0.05" required>
