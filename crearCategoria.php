...
<div class="row">
  ...
  <div class="col-6">
    ...
    <form action="crearCategoriadb.php" method="POST">
      <div class="form-group">
        <label for="formGroupDescripcion">Descripcion</label>
        <input type="text" class="form-control" name="descripcion" id="formGroupDescripcion" placeholder="Introduce una descripcion para la categoria" required>
        <br>
