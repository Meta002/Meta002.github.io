...
<main role="main" class="container">
  ...
  $sentencia = $mbd->prepare("SELECT
    ...
    a1.precio,
    a1.categoria_id,
    c1.descripcion as descategoria
FROM
    articulos a1
INNER JOIN categorias c1
    ON a1.categoria_id = c1.id;");
  $sentencia->execute();
        ...
        while($fila = $sentencia->fetch())
        {
         ?>
          <tr>
            ...
            <td><?php echo $fila['descategoria']; ?></td>
            <td><a class="btn btn-warning" href="editarArticulo.php?id=<?php echo $fila['id'];?>" role="button">Editar</a></td>
            <td><a class="btn btn-danger"  href="eliminarArticulodb.php?id=<?php echo $fila['id'];?>" onclick="return confirm('Estas seguro de eliminar este registro?')" role="button" >Eliminar</a></td>
          </tr>
      <?php
        }
      ?>
